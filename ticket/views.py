...
from ticket.models import Priority, Status, Project, Ticket, TicketComment
...
from ticket.utils import email_user
...
def create(request):
    ...
    return render(request, 'ticket/create.html', {'tab_users': user_list,
...
def view(request, ticket_id=1):
    ...
    return render(request, 'ticket/view.html', {'ticket': ticket,
...
def view_all(request):
    ...
    if created_filter == None and not request.user.is_staff:
        return HttpResponseRedirect("/tickets/?created_by=" + str(request.user.id))
    ...
    return render(request, 'ticket/view_all.html', {'tickets': tickets, 'filter': filter,
...
def update(request, ticket_id):
    ...
    return render(request, 'ticket/update.html', {'ticket': ticket, 'tab_users': users_list,
                                                        'priority_list': priority_list, 'status_list': status_list,
                                                        'project_list': project_list})
...
def project(request):
    ...
    return render(request, 'ticket/project.html', {'project_list': project_list})